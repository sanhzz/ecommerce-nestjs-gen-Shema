...
@Index("IDX_cart_line_item_cart_id", ["cartId"], {})
@Index("IDX_line_item_cart_id", ["cartId"], {})
@Index("IDX_cart_line_item_deleted_at", ["deletedAt"], {})
@Index("cart_line_item_pkey", ["id"], { unique: true })
@Index("IDX_line_item_product_id", ["productId"], {})
@Index("IDX_line_item_product_type_id", ["productTypeId"], {})
@Index("IDX_line_item_variant_id", ["variantId"], {})
@Entity("cart_line_item", { schema: "public" })
export class CartLineItem {
  ...
  @OneToMany(
    ...
    (cartLineItemAdjustment) => cartLineItemAdjustment.item
  )
  cartLineItemAdjustments: CartLineItemAdjustment[];

  @OneToMany(
    () => CartLineItemTaxLine,
    (cartLineItemTaxLine) => cartLineItemTaxLine.item
  )
