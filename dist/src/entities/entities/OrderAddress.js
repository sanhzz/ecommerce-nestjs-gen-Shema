...
], OrderAddress.prototype, "customerId", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Object)
], OrderAddress.prototype, "deletedAt", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Order_1.Order, (order) => order.billingAddress),
    __metadata("design:type", Array)
], OrderAddress.prototype, "orders", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Order_1.Order, (order) => order.shippingAddress),
    __metadata("design:type", Array)
], OrderAddress.prototype, "orders2", void 0);
exports.OrderAddress = OrderAddress = __decorate([
    (0, typeorm_1.Index)("IDX_order_address_customer_id", ["customerId"], {}),
    (0, typeorm_1.Index)("IDX_order_address_deleted_at", ["deletedAt"], {}),
    (0, typeorm_1.Index)("order_address_pkey", ["id"], { unique: true }),
    (0, typeorm_1.Entity)("order_address", { schema: "public" })
], OrderAddress);
